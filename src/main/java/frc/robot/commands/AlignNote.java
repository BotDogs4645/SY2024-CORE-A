...
public class AlignNote extends Command {
    ...
    public void initialize() {
        ...
        if (noteRotationalOffset.isPresent()) {
            advanceToTargetCommand = Optional.of(new AdvanceToTarget(drivetrain, playingField, new Transform2d(playingField.getRobotPose().getTranslation(), new Rotation2d(noteRotationalOffset.getAsDouble(), 0))));
        }
    }
